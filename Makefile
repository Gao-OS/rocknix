...
RK3588:
	unset DEVICE_ROOT
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=RK3588 ARCH=arm ./scripts/build_distro
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=RK3588 ARCH=aarch64 ./scripts/build_distro

RK3576:
	unset DEVICE_ROOT
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=RK3576 ARCH=arm ./scripts/build_distro
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=RK3576 ARCH=aarch64 ./scripts/build_distro

S922X:
	unset DEVICE_ROOT
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=S922X ARCH=arm ./scripts/build_distro
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=S922X ARCH=aarch64 ./scripts/build_distro

RK3566:
	unset DEVICE_ROOT
	DEVICE_ROOT=RK3566 DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=RK3566 ARCH=arm ./scripts/build_distro
	DEVICE_ROOT=RK3566 DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=RK3566 ARCH=aarch64 ./scripts/build_distro

RK3326:
	unset DEVICE_ROOT
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=RK3326 ARCH=arm ./scripts/build_distro
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=RK3326 ARCH=aarch64 ./scripts/build_distro

RK3399:
	unset DEVICE_ROOT
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=RK3399 ARCH=arm ./scripts/build_distro
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=RK3399 ARCH=aarch64 ./scripts/build_distro

H700:
	unset DEVICE_ROOT
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=H700 ARCH=arm ./scripts/build_distro
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=H700 ARCH=aarch64 ./scripts/build_distro

SM6115:
	unset DEVICE_ROOT
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=SM6115 ARCH=arm ./scripts/build_distro
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=SM6115 ARCH=aarch64 ./scripts/build_distro

SM8250:
	unset DEVICE_ROOT
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=SM8250 ARCH=arm ./scripts/build_distro
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=SM8250 ARCH=aarch64 ./scripts/build_distro

SM8550:
	unset DEVICE_ROOT
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=SM8550 ARCH=arm ./scripts/build_distro
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=SM8550 ARCH=aarch64 ./scripts/build_distro

SM8650:
	unset DEVICE_ROOT
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=SM8650 ARCH=aarch64 ./scripts/build_distro

SM8750:
	unset DEVICE_ROOT
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=SM8750 ARCH=aarch64 ./scripts/build_distro

update:
	DISTRO=GaoOS PROJECT=ROCKNIX DEVICE=RK3588 ARCH=aarch64 ./scripts/update_packages
...
docker-%: DOCKER_IMAGE := "ghcr.io/gao-os/gaoos-build:latest"
...
# ${HOME}/.GaoOS/options is a global options file containing developer and build settings.
docker-%: GLOBAL_SETTINGS := $(shell if [ -f "${HOME}/.GaoOS/options" ]; then echo "-v \"${HOME}/.GaoOS/options:${HOME}/.GaoOS/options\""; else echo ""; fi)
